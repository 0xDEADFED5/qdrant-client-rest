...
class QdrantRemote(QdrantBase):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if host is not None and (host.startswith("http://") or host.startswith("https://")):
            raise ValueError(
                f"`host` param is not expected to contain protocol (http:// or https://). " f"Try to use `url` parameter instead."
            )
            ...
            if self._prefix and parsed_url.path:
                raise ValueError(
                    "Prefix can be set either in `url` or in `prefix`. " f"url is {url}, prefix is {parsed_url.path}"
                )
        ...
        _timeout = math.ceil(timeout) if timeout is not None else None  # it has been changed from float to int.
        ...
        if check_compatibility:
            try:
                client_version = importlib.metadata.version("qdrant-client")
                server_version = get_server_version(self.rest_uri, self._rest_headers, self._rest_args.get("auth"))
    ...
    def search_batch(
        ...
        **kwargs: Any,
        ...
        http_res: Optional[list[list[models.ScoredPoint]]] = self.http.search_api.search_batch_points(
            collection_name=collection_name,
    ...
    def query_batch_points(
        ...
        **kwargs: Any,
        ...
        http_res: Optional[list[models.QueryResponse]] = self.http.search_api.query_batch_points(
            collection_name=collection_name,
            consistency=consistency,
            timeout=timeout,
    ...
    def scroll(
        ...
        **kwargs: Any,
        ...
        scroll_result: Optional[models.ScrollResult] = self.openapi_client.points_api.scroll_points(
            collection_name=collection_name,
            consistency=consistency,
    ...
    def _try_argument_to_rest_selector(
        ...
        #     points_selector.shard_key = shard_key_selector
            ...
            points_selector = construct(models.FilterSelector, filter=points, shard_key=shard_key_selector)
        # elif isinstance(points, grpc.Filter):
        #     points_selector = construct(
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        #     )
        # else:
        points_selector = self._try_argument_to_rest_selector(points_selector, shard_key_selector)
    ...
    def batch_update_points(
        ...
        **kwargs: Any,
        ...
        #     ]
        # else:
        result: Optional[list[types.UpdateResult]] = self.openapi_client.points_api.batch_update(
            collection_name=collection_name,
            wait=wait,
            ordering=ordering,
    ...
    def update_collection_aliases(
        ...
        **kwargs: Any,
        ...
        result: Optional[bool] = self.http.aliases_api.update_aliases(
            timeout=timeout,
            change_aliases_operation=models.ChangeAliasesOperation(actions=change_aliases_operation),
        ).result
    ...
    def get_collection_aliases(self, collection_name: str, **kwargs: Any) -> types.CollectionsAliasesResponse:
        ...
        result: Optional[types.CollectionsAliasesResponse] = self.http.aliases_api.get_collection_aliases(
            collection_name=collection_name
        ).result
    ...
    def get_aliases(self, **kwargs: Any) -> types.CollectionsAliasesResponse:
        ...
        #         ]
        #     )
        result: Optional[types.CollectionsAliasesResponse] = self.http.aliases_api.get_collections_aliases().result
    ...
    def delete_collection(self, collection_name: str, timeout: Optional[int] = None, **kwargs: Any) -> bool:
        ...
        result: Optional[bool] = self.http.collections_api.delete_collection(collection_name, timeout=timeout).result
    ...
    def _upload_collection(
        ...
        if method is not None:
            if method in get_all_start_methods():
                ...
                raise ValueError(f"Start methods {method} is not available, available methods: {get_all_start_methods()}")
        else:
    ...
    def upload_points(
        ...
        **kwargs: Any,
        ...
        batches_iterator = self._updater_class.iterate_records_batches(records=points, batch_size=batch_size)
    ...
    def create_payload_index(
        ...
        **kwargs: Any,
        ...
        result: Optional[types.UpdateResult] = self.openapi_client.indexes_api.create_field_index(
            collection_name=collection_name,
            create_field_index=models.CreateFieldIndex(field_name=field_name, field_schema=field_schema),
            wait=wait,
            ordering=ordering,
        ).result
    ...
    def list_snapshots(self, collection_name: str, **kwargs: Any) -> list[types.SnapshotDescription]:
        ...
        snapshots = self.openapi_client.snapshots_api.list_snapshots(collection_name=collection_name).result
    ...
    def create_snapshot(self, collection_name: str, wait: bool = True, **kwargs: Any) -> Optional[types.SnapshotDescription]:
        ...
        return self.openapi_client.snapshots_api.create_snapshot(collection_name=collection_name, wait=wait).result
    ...
    def delete_full_snapshot(self, snapshot_name: str, wait: bool = True, **kwargs: Any) -> Optional[bool]:
        ...
        return self.openapi_client.snapshots_api.delete_full_snapshot(snapshot_name=snapshot_name, wait=wait).result
    ...
    def unlock_storage(self, **kwargs: Any) -> types.LocksOption:
        result: Optional[types.LocksOption] = self.openapi_client.service_api.post_locks(models.LocksOption(write=False)).result
